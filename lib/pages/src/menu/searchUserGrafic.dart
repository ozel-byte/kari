...
import 'package:bioappmikary/pages/src/menu/grafic.dart';
...
class SearchUserGrafic extends StatefulWidget {
  const SearchUserGrafic({super.key});

  @override
  State<SearchUserGrafic> createState() => _BuscarUserState();
}

class _BuscarUserState extends State<SearchUserGrafic> {
